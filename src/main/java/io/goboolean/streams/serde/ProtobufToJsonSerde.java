...
// **Deprecated**
public class ProtobufToJsonSerde<T extends com.google.protobuf.GeneratedMessageV3> implements Serde<T> {
    private final Serializer<T> serializer;
    private final Deserializer<T> deserializer;

    public ProtobufToJsonSerde(Serializer<T> serializer, Deserializer<T> deserializer) {
